...
const char* ssid = "Vista"; //VARIÁVEL QUE ARMAZENA O NOME DA REDE SEM FIO EM QUE VAI CONECTAR
const char* password = "12471247"; //VARIÁVEL QUE ARMAZENA A SENHA DA REDE SEM FIO EM QUE VAI CONECTAR
...
client.println("<h1><center>Ola Rubem!</center></h1>"); //ESCREVE "Ola cliente!" NA PÁGINA
